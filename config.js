...
FOOTER: process.env.FOOTER === undefined ? 'ROIYA-ᴍᴅ ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴀʀᴀᴛᴇᴅ ʙʏ ROIYA-ᴍᴅ*' : process.env.CAPTION,
